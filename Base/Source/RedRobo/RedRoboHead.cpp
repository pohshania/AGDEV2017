...
void CRedRoboHead::Init(float x, float y, float z)
{
	// Set speed
	m_dSpeed = 0.05f;
	...
	InitLOD("RedRoboHead", "RedRoboHead", "sphere");
...
// Set position
void CRedRoboHead::SetPos(const Vector3& pos)
{
	position = pos;
}

// Set target
void CRedRoboHead::SetTarget(const Vector3& target)
{
	this->target = target;
}
// Set Up
void CRedRoboHead::SetUp(const Vector3& up)
{
	this->up = up;
}
// Set the boundary for the player info
void CRedRoboHead::SetBoundary(Vector3 max, Vector3 min)
{
	maxBoundary = max;
	minBoundary = min;
}
// Set the terrain for the player info
void CRedRoboHead::SetTerrain(GroundEntity* m_pTerrain)
{
	if (m_pTerrain != NULL)
	{
...
// Get position
Vector3 CRedRoboHead::GetPos(void) const
{
	return position;
}

// Get target
Vector3 CRedRoboHead::GetTarget(void) const
{
	return target;
}
// Get Up
Vector3 CRedRoboHead::GetUp(void) const
{
	return up;
}
// Get the terrain for the player info
GroundEntity* CRedRoboHead::GetTerrain(void)
{
	return m_pTerrain;
}

// Update
void CRedRoboHead::Update(double dt)
{
...
void CRedRoboHead::Constrain(void)
{
