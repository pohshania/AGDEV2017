...
void CRedRoboBottom::Init(float x, float y, float z)
{
	// Set speed
	m_dSpeed = 0.05f;
	...
	InitLOD("RedRoboBottom", "RedRoboBottom", "sphere");
...
void CRedRoboBottom::Reset(void)
{
...
// Set position
void CRedRoboBottom::SetPos(const Vector3& pos)
{
	position = pos;
}

// Set target
void CRedRoboBottom::SetTarget(const Vector3& target)
{
	this->target = target;
}
// Set Up
void CRedRoboBottom::SetUp(const Vector3& up)
{
	this->up = up;
}
// Set the boundary for the player info
void CRedRoboBottom::SetBoundary(Vector3 max, Vector3 min)
{
	maxBoundary = max;
	minBoundary = min;
}
// Set the terrain for the player info
void CRedRoboBottom::SetTerrain(GroundEntity* m_pTerrain)
{
	if (m_pTerrain != NULL)
	{
...
// Get position
Vector3 CRedRoboBottom::GetPos(void) const
{
	return position;
}

// Get target
Vector3 CRedRoboBottom::GetTarget(void) const
{
	return target;
}
// Get Up
Vector3 CRedRoboBottom::GetUp(void) const
{
	return up;
}
// Get the terrain for the player info
GroundEntity* CRedRoboBottom::GetTerrain(void)
{
	return m_pTerrain;
}

// Update
void CRedRoboBottom::Update(double dt)
{
...
void CRedRoboBottom::Constrain(void)
{
...
// Render
void CRedRoboBottom::Render(void)
{
