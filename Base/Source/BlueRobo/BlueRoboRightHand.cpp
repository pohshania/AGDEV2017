...
CBlueRoboRightHand::CBlueRoboRightHand()
	: GenericEntity(NULL)
...
void CBlueRoboRightHand::Init(float x, float y, float z)
{
	// Set speed
	m_dSpeed = 0.05f;
	...
	InitLOD("BlueRoboRightHand", "BlueRoboRightHand", "BlueRoboRightHand");
...
void CBlueRoboRightHand::Reset(void)
{
...
// Set position
void CBlueRoboRightHand::SetPos(const Vector3& pos)
{
	position = pos;
}

// Set target
void CBlueRoboRightHand::SetTarget(const Vector3& target)
{
	this->target = target;
}
// Set Up
void CBlueRoboRightHand::SetUp(const Vector3& up)
{
	this->up = up;
}
// Set the boundary for the player info
void CBlueRoboRightHand::SetBoundary(Vector3 max, Vector3 min)
{
	maxBoundary = max;
	minBoundary = min;
}
// Set the terrain for the player info
void CBlueRoboRightHand::SetTerrain(GroundEntity* m_pTerrain)
{
	if (m_pTerrain != NULL)
	{
...
// Get position
Vector3 CBlueRoboRightHand::GetPos(void) const
{
	return position;
}

// Get target
Vector3 CBlueRoboRightHand::GetTarget(void) const
{
	return target;
}
// Get Up
Vector3 CBlueRoboRightHand::GetUp(void) const
{
	return up;
}
// Get the terrain for the player info
GroundEntity* CBlueRoboRightHand::GetTerrain(void)
{
	return m_pTerrain;
}

// Update
void CBlueRoboRightHand::Update(double dt)
{
...
void CBlueRoboRightHand::Constrain(void)
{
...
// Render
void CBlueRoboRightHand::Render(void)
{
