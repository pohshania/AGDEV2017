...
CBlueRoboLeftHand::CBlueRoboLeftHand()
	: GenericEntity(NULL)
...
void CBlueRoboLeftHand::Init(float x, float y, float z)
{
	// Set speed
	m_dSpeed = 0.05f;
	...
	InitLOD("BlueRoboLeftHand", "BlueRoboLeftHand", "BlueRoboLeftHand");
...
void CBlueRoboLeftHand::Reset(void)
{
...
// Set position
void CBlueRoboLeftHand::SetPos(const Vector3& pos)
{
	position = pos;
}

// Set target
void CBlueRoboLeftHand::SetTarget(const Vector3& target)
{
	this->target = target;
}
// Set Up
void CBlueRoboLeftHand::SetUp(const Vector3& up)
{
	this->up = up;
}
// Set the boundary for the player info
void CBlueRoboLeftHand::SetBoundary(Vector3 max, Vector3 min)
{
	maxBoundary = max;
	minBoundary = min;
}
// Set the terrain for the player info
void CBlueRoboLeftHand::SetTerrain(GroundEntity* m_pTerrain)
{
	if (m_pTerrain != NULL)
	{
...
// Get position
Vector3 CBlueRoboLeftHand::GetPos(void) const
{
	return position;
}

// Get target
Vector3 CBlueRoboLeftHand::GetTarget(void) const
{
	return target;
}
// Get Up
Vector3 CBlueRoboLeftHand::GetUp(void) const
{
	return up;
}
// Get the terrain for the player info
GroundEntity* CBlueRoboLeftHand::GetTerrain(void)
{
	return m_pTerrain;
}

// Update
void CBlueRoboLeftHand::Update(double dt)
{
...
void CBlueRoboLeftHand::Constrain(void)
{
...
// Render
void CBlueRoboLeftHand::Render(void)
{
