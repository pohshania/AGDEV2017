...
CBlueRoboBottom::CBlueRoboBottom()
	: GenericEntity(NULL)
...
void CBlueRoboBottom::Init(float x, float y, float z)
{
	// Set speed
	m_dSpeed = 0.05f;
	...
	InitLOD("BlueRoboBottom", "BlueRoboBottom", "sphere");
...
void CBlueRoboBottom::Reset(void)
{
...
// Set position
void CBlueRoboBottom::SetPos(const Vector3& pos)
{
	position = pos;
}

// Set target
void CBlueRoboBottom::SetTarget(const Vector3& target)
{
	this->target = target;
}
// Set Up
void CBlueRoboBottom::SetUp(const Vector3& up)
{
	this->up = up;
}
// Set the boundary for the player info
void CBlueRoboBottom::SetBoundary(Vector3 max, Vector3 min)
{
	maxBoundary = max;
	minBoundary = min;
}
// Set the terrain for the player info
void CBlueRoboBottom::SetTerrain(GroundEntity* m_pTerrain)
{
	if (m_pTerrain != NULL)
	{
...
// Get position
Vector3 CBlueRoboBottom::GetPos(void) const
{
	return position;
}

// Get target
Vector3 CBlueRoboBottom::GetTarget(void) const
{
	return target;
}
// Get Up
Vector3 CBlueRoboBottom::GetUp(void) const
{
	return up;
}
// Get the terrain for the player info
GroundEntity* CBlueRoboBottom::GetTerrain(void)
{
	return m_pTerrain;
}

// Update
void CBlueRoboBottom::Update(double dt)
{
...
void CBlueRoboBottom::Constrain(void)
{
...
// Render
void CBlueRoboBottom::Render(void)
{
